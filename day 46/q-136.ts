...
// demonstrate using console.log() insikde a loop to track variable outside.
for(let i = 1 ; i <= 5 ; i++){
    console.log(`Iteration ${i}, i value: , i`); //logs the current iteration number and the valu of i
}
